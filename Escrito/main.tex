...
\title{Posición Solar, Descomposición Estadística y Cuantificación de Incertidumbre mediante Temporal Fusion Transformer para el Forecasting del Costo Marginal en el SEN}
...
%\comision{Nombre Completo Uno,Nombre Completo Dos,Nombre Completo Tres} % TODO: completar cuando se defina la comisión
...
\input{1. Introducción}
\input{2. Marco Teórico}
\input{3. Metodología}
\input{4. Resultados}
\input{conclu.tex}
